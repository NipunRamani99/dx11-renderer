...
{
  public:
    static IndexedTriangleList MakeTesselatedTextured( Dvtx::VertexLayout vertexLayout, int divisions_x,
                                                       int divisions_y, float scale = 1.0f )
    {
        ...
        dx::XMFLOAT3 normal = dx::XMFLOAT3( 0.0f, 0.0f, 1.0f );
        {
            ...
            for( int y = 0, i = 0; y < nVertices_y; y++ )
            {
                ...
                for( int x = 0; x < nVertices_x; x++, i++ )
                {
                    ...
                    vertexBuffer.EmplaceBack( dx::XMFLOAT3{ scale * x_pos, scale * y_pos, 0.0f },
                                              dx::XMFLOAT3{ 0.0f, 0.0f, 1.0f }, dx::XMFLOAT3{ 1.0f, 0.0f, 0.0f },
